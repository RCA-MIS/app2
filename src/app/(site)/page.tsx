                                ...
                                <table className="w-full rounded-lg text-[rgba(67,67,67,0.71)]">
                                        ...
                                        {projects.map((project, index) => (
                                                ...
                                                >
                                                        ...
                                                        <td className="p-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="18" viewBox="0 0 21 18" className='cursor-pointer w-5 h-5 mx-auto fill-blue-500'>
                                                        ...
                                                        <td className="p-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className='cursor-pointer w-5 h-5 mx-auto '>
