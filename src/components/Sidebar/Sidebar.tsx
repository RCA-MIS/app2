                ...
                <div className='bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md h-full  w-fit md:w-[25vw] lg:w-[20vw] text-[#00000075] text-sm'>
                        ...
                        <div className='font-medium'>
                                <Link onClick={() => setActiveLink("Dashboard")} href={"/"}
                                        className={activeLink === "Dashboard" ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
                                ...
                                <Link onClick={() => setActiveLink("Report-Cards")} href={"/report-cards"}
                                        className={activeLink === "Report-Cards" ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
                                ...
                                <Link onClick={() => setActiveLink("Innovations")} href={"/innovations"}
                                        className={activeLink === "Innovations" ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
                                ...
                                <Link onClick={() => setActiveLink("Parents | Students")} href={"/parents-students"}
                                        className={activeLink === "Parents | Students" ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
                                ...
                                <Link onClick={() => setActiveLink("Customizations")} href={"/customizations"}
                                        className={activeLink === "Customizations" ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
                                ...
                                <Link onClick={() => setActiveLink("Profile")} href={"/profile"}
                                        className={activeLink === "Profile" ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] hover:fill-[]'}>
