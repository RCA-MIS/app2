...
const Sidebar = () => {
        ...
        return (
                <div className='hidden md:block bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md h-full  w-fit md:w-[25vw] lg:w-[20vw] text-[#00000075] text-sm'>
                        ...
                        <div className='font-medium'>
                                ...
                                <Link href={"/innovations"}
                                        ...
                                        <p className='hidden md:block transition-all duration-200'>{"Innovations"}</p>
                                </Link>
                                <Link href={"/parents-students"}
                                        ...
                                        <p className='hidden md:block transition-all duration-200'>{"Parents | Students"}</p>
                                </Link>
                                <Link href={"/customizations"}
                                        ...
                                        <p className='hidden md:block transition-all duration-200'>{"Customizations"}</p>
                                </Link>
                                <Link  href={"/profile"}
