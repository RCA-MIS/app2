                                ...
                                <div className="flex flex-row gap-3 h-[30vh] my-2">
                                        <div className="w-[40%] h-full flex flex-col gap-3">
                                                ...
                                                <div className='h-[50%] flex flex-row gap-3 '>
                                                        <div className='bg-[rgba(8,40,210,0.09)] border  border-[rgba(8,40,210,0.47)]  text-[rgba(8,40,210,0.47)] rounded-md  w-[50%] py-2'>
                                                                <p className='font-extrabold text-[37px]'>234</p>
                                                                <p className='font-extrabold text-xs'>Parents</p>
                                                        </div>
                                                        <div className='bg-[rgba(82,56,115,0.17)] border  border-[rgba(82,56,115,0.55)] text-[rgba(82,56,115,0.55)] rounded-md  w-[50%] py-2'>
                        ...
                        <div className='w-[30%]  h-[100%] overflow-y-auto bg-[#D9D9D975] border-2 border-[#43434305] p-2 rounded-md'>
                                <div>
                                        <div className="flex flex-row justify-between">
                                                <p className='text-[rgba(67,67,67,0.47)] font-semibold my-2'>Achievements</p>
                                                <div className="h-5 w-5 rounded-full bg-[#687CE2] text-white flex justify-center items-center text-xs">82</div>
                                        </div>
                                        <div>
                                                <Achievement image={newOne} date={new Date()} title={"World Bank Fund RCA tomorrow"} content={"Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, cons, adipisci . . ."} />
                                                <Achievement image={newTwo} date={new Date()} title={"World Bank Fund RCA tomorrow"} content={"Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, cons, adipisci . . ."} />
                                        </div>
                                </div>
                                <div>
                                        ...
                                        <form>
                                                <input type="text" placeholder='Anouncement Heading' className=' px-3 py-2 text-[rgba(0,0,0,0.8)] placeholder:text-[rgba(75,75,75,0.69)] bg-[rgba(67,67,67,0.03)]  rounded-md border-[2px] border-[rgba(67,67,67,0.09)] w-full my-2' />
                                                <textarea placeholder='Anouncement Body' className="text-[rgba(0,0,0,0.8)] placeholder:text-[rgba(75,75,75,0.69)] bg-[rgba(67,67,67,0.03)]  rounded-md border-[2px] border-[rgba(67,67,67,0.09)] w-full px-3 py-2 my-2"></textarea>
                                                <input type="submit" value="Publish Anouncement" className='bg-[rgba(82,56,115)] rounded-md text-white px-5 py-2 w-full my-2 text-base font-medium' />
                                        </form>
                                </div>
                        </div>
