                                ...
                                <div className="flex flex-row gap-3 h-[30vh] my-2">
                                        <div className="w-[40%] h-full flex flex-col gap-3">
                                                ...
                                                <div className='h-[50%] flex flex-row gap-3 '>
                                                        <div className='bg-[rgba(8,40,210,0.09)] border  border-[rgba(8,40,210,0.47)]  text-[rgba(8,40,210,0.47)] rounded-md  w-[50%]'>
                                                                <p className='font-extrabold text-[37px]'>234</p>
                                                                <p className='font-extrabold text-xs'>Parents</p>
                                                        </div>
                                                        <div className='bg-[rgba(82,56,115,0.17)] border  border-[rgba(82,56,115,0.55)] text-[rgba(82,56,115,0.55)] rounded-md  w-[50%]'>
