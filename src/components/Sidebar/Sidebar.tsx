                ...
                <div className='bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md h-full  w-fit md:w-[25vw] lg:w-[20vw] text-[#00000075] text-sm'>
                        ...
                        <div className='font-medium'>
                                ...
                                <Link onClick={() => setActiveLink("Report-Cards")} href={"/report-cards"}
                                        ...
                                        <p className='hidden md:block'>{"Report-Cards"}</p>
                                </Link>
                                <Link onClick={() => setActiveLink("Innovations")} href={"/innovations"}
                                        className={isActiveLink("/innovations") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
                                        ...
                                        <p className='hidden md:block'>{"Innovations"}</p>
                                </Link>
                                <Link onClick={() => setActiveLink("Parents | Students")} href={"/parents-students"}
                                        className={isActiveLink("/parents-students") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)]' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)]'}>
